...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8528612090:AAFMQAImLZNFcF6rF7noajC9iK6z22HdPnk")
...
TOKEN_SETS = [
    ...
    },
    {
        ...
        "hash_params": "app_user_id,fetch_token,app_transaction:sha256:3fd942ea6d47700bbfc39670bc1d756e0e2f5e76e0f9c19dd93ea961cb7eb52f",
        "hash_headers": "X-Is-Sandbox:sha256:fcbcf165908dd18a9e49f7ff27810176db8e9f63b4352213741664245224f8aa",
        "is_sandbox": False,
    },
]
...
TEXTS = {
    "VI": {
        ...
        "maintenance": f"{E_ERROR} <b>Bot đang bảo trì</b>\nVui lòng quay lại sau.",
        "bot_on": f"{E_SUCCESS} Bot đã được <b>BẬT</b> lại.",
        "bot_off": f"{E_ERROR} Bot đã được <b>TẮT</b>.",
        "token_added": f"{E_SUCCESS} Đã thêm token: <code>{{}}</code>",
        "token_deleted": f"{E_SUCCESS} Đã xoá token #{{}}.",
        "token_not_found": f"{E_ERROR} Không tìm thấy token #{{}}.",
        "token_parse_error": f"{E_ERROR} Không thể parse token từ nội dung. Hãy paste nội dung file request (.txt).",
        "token_prompt": f"{E_LOADING} Paste nội dung file request (.txt) vào đây:",
        "vip_added": f"{E_SUCCESS} Đã thêm VIP cho user <code>{{}}</code>.",
        "vip_removed": f"{E_SUCCESS} Đã xoá VIP cho user <code>{{}}</code>.",
        "vip_not_found": f"{E_ERROR} User <code>{{}}</code> không phải VIP.",
    ...
    "EN": {
        ...
        "maintenance": f"{E_ERROR} <b>Bot is under maintenance</b>\nPlease come back later.",
        "bot_on": f"{E_SUCCESS} Bot has been <b>turned ON</b>.",
        "bot_off": f"{E_ERROR} Bot has been <b>turned OFF</b>.",
        "token_added": f"{E_SUCCESS} Token added: <code>{{}}</code>",
        "token_deleted": f"{E_SUCCESS} Token #{{}} deleted.",
        "token_not_found": f"{E_ERROR} Token #{{}} not found.",
        "token_parse_error": f"{E_ERROR} Cannot parse token from content. Please paste the request file (.txt) content.",
        "token_prompt": f"{E_LOADING} Paste the request file (.txt) content here:",
        "vip_added": f"{E_SUCCESS} VIP added for user <code>{{}}</code>.",
        "vip_removed": f"{E_SUCCESS} VIP removed for user <code>{{}}</code>.",
        "vip_not_found": f"{E_ERROR} User <code>{{}}</code> is not VIP.",
